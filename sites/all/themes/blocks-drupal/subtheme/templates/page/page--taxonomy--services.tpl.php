	  ...
	  <div id="main_content_wrap" class="<?php if (($page['sidebar_first']) OR ($page['sidebar_second'])) { echo "eight columns";} else { echo "twelve columns"; } ?>">      <?php print $messages; ?>       
	    <div id="main_content" class="clearfix">
		  ...
		  <!--  To show the image and the description from term page -->
	     	...
	     	<?php //print render($page['content']);  //taxonomy associated blog contents are showing?>
			<?php 
			
							//print views_embed_view('relevant_case_studies','block');
				print views_embed_view('relevant_case_studies','default');
				//print views_embed_view('service_categories','default');
           ?>
	    </div>
	  </div>
